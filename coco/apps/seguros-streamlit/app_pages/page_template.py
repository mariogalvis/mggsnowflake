...
def _get_ai_diagnostic(title, subtitle, kpi_summary):
    prompt = f"""Eres un analista senior de seguros en Colombia. Analiza estos KPIs del modulo "{title}" ({subtitle}).
            ...
            if trend_query and trend_cols:
                ...
                if not t_df.empty:
                    ...
                    fig_t.add_trace(go.Scatter(
                        ...
                        textfont=dict(size=10, color="#264653"),
                    ))
                ...
                if not tm_df.empty:
                    fig_tree = go.Figure(go.Treemap(
                        ...
                        marker=dict(
                            ...
                            colorscale=treemap_config.get("colorscale", [[0, "#E9C46A"], [0.3, "#2A9D8F"], [0.6, "#1D7847"], [1, "#264653"]]),
        ...
        if geo_query and geo_config:
            ...
            if not geo_df.empty:
                ...
                deck = colombia_scatter_map(
                    ...
                    colorscale=geo_config.get("colorscale", ["#06D6A0", "#F4A261", "#E63946"]),
                )
            ...
            with col_result:
                ...
                fig_gauge = go.Figure(go.Indicator(
                    ...
                    gauge={
                        ...
                        "steps": [
                            {"range": [0, thresholds[0] * 100], "color": "#D8F3DC"},
