#¿Cuales son nuestros 3 negocios más grandes con clientes?
# Cuéntame los detalles más importantes de la última llamada con RápidoExpress S.A.S.
#Cuál es el siguiente paso de la última llamada con RápidoExpress S.A.S.
...
def main():
    ...
    if query := st.chat_input("¿Qué quieres preguntar?"):
