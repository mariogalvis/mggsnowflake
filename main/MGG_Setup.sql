...
EXECUTE IMMEDIATE FROM @mgg_files/sql/utilities.sql;

EXECUTE IMMEDIATE FROM @mgg_files/sql/cortex_search.sql;

EXECUTE IMMEDIATE FROM @mgg_files/sql/cortex_analyst.sql;

EXECUTE IMMEDIATE FROM @mgg_files/sql/dynamic_tables.sql;
